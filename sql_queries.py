...
song_table_create = ("CREATE TABLE songs(song_id varchar, tittle varchar, artist_id varchar, year int, duration float);")
...
song_table_insert = ("INSERT INTO songs(song_id, tittle, artist_id, year, duration) VALUES(%s, %s, %s, %s, %s)")
